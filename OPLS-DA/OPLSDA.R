...
library(gridExtra)
# input data
setwd("C:/data/metabolism/Mqc/文章/final/Metabolomics/revision/OPLS-DA")
...
# output data
write.csv(dd, "opls_data.csv", row.names = FALSE)
write.csv(vip_data, "VIP_all.csv",row.names=F)
